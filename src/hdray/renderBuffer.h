...
#ifndef HDRAY_RENDERBUFFER_H
#define HDRAY_RENDERBUFFER_H
...
class HdRayRenderBuffer final: public HdRenderBuffer
{
public:
    HdRayRenderBuffer(SdfPath const& id);
    ~HdRayRenderBuffer() override;
